...
data class SeatViewDto(
    ...
    val pendingExplore: PendingExploreViewDto?,
    ...
    val pendingCascade: PendingCascadeDto? = null,
...
fun SeatView.toDto(): SeatViewDto =
    SeatViewDto(
        ...
        pendingExplore = pendingExplore?.toDto(),
        ...
        pendingCascade = pendingCascade?.toDto(),
...
fun SeatViewDto.toDomain(): SeatView =
    SeatView(
        ...
        pendingExplore = pendingExplore?.toDomain(),
        ...
        pendingCascade = pendingCascade?.toDomain(),
