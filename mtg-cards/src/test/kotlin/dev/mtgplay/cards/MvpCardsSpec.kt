        ...
        "the registry maps every definition under its printed name, ready for MatchConfig" {
            MvpCards.definitions.keys shouldBe
                setOf(
                    ...
                    CardRef("Gorilla Shaman"),
                    CardRef("Weather the Storm"),
                    CardRef("Searing Blaze"),
                    ...
                    CardRef("Bender's Waterskin"),
                    CardRef("Citadel Gate"),
                    CardRef("Cliffgate"),
                    CardRef("Conduit Pylons"),
                    CardRef("Manor Gate"),
                    CardRef("Mortuary Mire"),
                    CardRef("Balustrade Spy"),
                    CardRef("Azorius Chancery"),
                    CardRef("Blood Fountain"),
                    CardRef("Bojuka Bog"),
                    CardRef("Blue Elemental Blast"),
                    CardRef("Bonder's Ornament"),
                    CardRef("Boulderbranch Golem"),
                    CardRef("Barrels of Blasting Jelly"),
                    CardRef("Brainstorm"),
                    CardRef("Burning-Tree Emissary"),
                    ...
                    CardRef("Duress"),
                    CardRef("Elves of Deep Shadow"),
                    CardRef("Dust to Dust"),
                    ...
                    CardRef("Sunscape Familiar"),
                    CardRef("Standard Bearer"),
                    CardRef("Stonehorn Dignitary"),
                    CardRef("Swamp"),
