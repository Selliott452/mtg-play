 ...
 * their own** (TapEffects.kt): [harrierStrix] (tap target permanent), [sleepOfTheDead] (tap, and it
 * does not untap next untap step), [quirionRanger] (return a Forest you control: untap target
