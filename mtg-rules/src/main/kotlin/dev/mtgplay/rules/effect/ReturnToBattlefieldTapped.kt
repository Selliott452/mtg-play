...
import dev.mtgplay.rules.engine.detectEnterBattlefieldTriggers
 ...
 * with no marked damage. Its own enters-the-battlefield triggers then fire (CR 603.6a,
 * [detectEnterBattlefieldTriggers]); Sneaky Snacker has none. Emits [GameEvent.PermanentEntered] as
 * any permanent entry does — the object entered the battlefield, not a spell resolution's graveyard
 * move.
 *
...
fun returnFromGraveyardToBattlefieldTapped(
    ...
    val entered =
        allocated
            ...
            .emit(GameEvent.PermanentEntered(owner, objectId, leaving.card, battlefieldId))
    return detectEnterBattlefieldTriggers(entered, battlefieldId)
}
