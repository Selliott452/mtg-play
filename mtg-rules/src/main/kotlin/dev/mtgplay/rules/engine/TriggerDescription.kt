...
/*
 * How a fired trigger is *named* for the CR 603.3b ordering decision (ADR-005) — one concept, one file.
 *
 ...
 * sitting in a zone — the general "whenever a spell is cast" (CR 603.2) and the three engine-synthesized
 ...
 * breaks compilation twice over rather than falling silently into a branch — which for this function
