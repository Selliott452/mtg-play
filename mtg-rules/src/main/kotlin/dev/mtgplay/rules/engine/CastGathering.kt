...
internal fun beginCastGathering(
    ...
    val chosenTargets: PersistentList<Target>? =
        when (definition.targetSpec) {
            ...
            // An Aura (CR 601.2c), any-target, and target-opponent all need a target choice before payment.
            TargetSpec.TargetOpponent, TargetSpec.AnyTarget, is TargetSpec.Enchantable -> null
        }
