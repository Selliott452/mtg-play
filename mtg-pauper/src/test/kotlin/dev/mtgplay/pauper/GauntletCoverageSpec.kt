...
private const val TOTAL_ENCODED_SIDEBOARD = 29
private const val TOTAL_MISSING_SIDEBOARD = 19

/** The whole backlog: distinct undefined cards across both boards of all thirteen decks. */
private const val TOTAL_MISSING_BOTH_BOARDS = 83

/** Of the backlog, the cards that appear only in sideboards. */
private const val TOTAL_MISSING_SIDEBOARD_ONLY = 16
