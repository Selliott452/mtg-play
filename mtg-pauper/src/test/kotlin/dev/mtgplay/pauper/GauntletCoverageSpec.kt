        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Mono-Red Madness", 11, 12, 0, 5),
...
private const val TOTAL_ENCODED_MAIN = 29
private const val TOTAL_MISSING_MAIN = 149
...
private const val TOTAL_MISSING_BOTH_BOARDS = 191
