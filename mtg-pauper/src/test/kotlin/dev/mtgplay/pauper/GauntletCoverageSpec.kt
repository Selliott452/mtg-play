        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Gates", 14, 17, 5, 5),
                    Pinned("Grixis Affinity", 19, 22, 5, 7),
                    Pinned("GW Bogles", 18, 18, 7, 8),
                    Pinned("Jeskai Ephemerate", 20, 22, 6, 7),
...
private const val TOTAL_ENCODED_MAIN = 152
private const val TOTAL_MISSING_MAIN = 26

/** Distinct cards named by at least one gauntlet sideboard. */
private const val TOTAL_DISTINCT_SIDEBOARD = 48
private const val TOTAL_ENCODED_SIDEBOARD = 34
private const val TOTAL_MISSING_SIDEBOARD = 14

/** The whole backlog: distinct undefined cards across both boards of all thirteen decks. */
private const val TOTAL_MISSING_BOTH_BOARDS = 38

/** Of the backlog, the cards that appear only in sideboards. */
private const val TOTAL_MISSING_SIDEBOARD_ONLY = 12
