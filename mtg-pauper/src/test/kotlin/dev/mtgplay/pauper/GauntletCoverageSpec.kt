        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Mono Red Rally", 6, 13, 2, 5),
...
private const val TOTAL_ENCODED_MAIN = 111
private const val TOTAL_MISSING_MAIN = 67
...
private const val TOTAL_MISSING_BOTH_BOARDS = 86
