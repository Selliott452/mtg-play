        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Mono Red Rally", 7, 13, 2, 5),
                    Pinned("Monster Tron", 10, 21, 4, 6),
...
private const val TOTAL_ENCODED_MAIN = 112
private const val TOTAL_MISSING_MAIN = 66
...
private const val TOTAL_MISSING_BOTH_BOARDS = 85
