        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Mono Red Rally", 8, 13, 4, 5),
                    Pinned("Monster Tron", 15, 21, 4, 6),
                    Pinned("Spy Combo", 12, 21, 4, 8),
...
private const val TOTAL_ENCODED_MAIN = 138
private const val TOTAL_MISSING_MAIN = 40
