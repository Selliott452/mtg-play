        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Jeskai Ephemerate", 13, 22, 1, 7),
                    Pinned("Jund Wildfire", 11, 22, 2, 7),
                    Pinned("Mono Blue Faeries", 4, 14, 1, 6),
                    Pinned("Mono-Blue Terror", 10, 14, 3, 6),
                    Pinned("Mono-Red Madness", 12, 12, 1, 5),
                    Pinned("Mono Red Rally", 5, 13, 1, 5),
                    Pinned("Monster Tron", 6, 21, 3, 6),
                    Pinned("Spy Combo", 3, 21, 2, 8),
                    Pinned("UWX Familiar", 9, 20, 3, 6),
                )
        }
...
private const val TOTAL_ENCODED_MAIN = 83
private const val TOTAL_MISSING_MAIN = 95
...
private const val TOTAL_MISSING_BOTH_BOARDS = 123
