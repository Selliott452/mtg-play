        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    // `W10-C` added Nyxborn Hydra on bestow (CR 702.103): 13 -> 14.
                    ...
                    // `W10-C` added Nyxborn Hydra here too, the deck's second copy of the card: 19 -> 20.
                    ...
                    // `W10-C` added Pinnacle Kill-Ship, the one Spacecraft in the gauntlet: 19 -> 20.
...
private const val TOTAL_ENCODED_SIDEBOARD = 45
