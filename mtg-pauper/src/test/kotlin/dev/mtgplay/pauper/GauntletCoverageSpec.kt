    ...
    StringSpec({
        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                // `W9-C` added Searing Blaze, Gorilla Shaman, and Weather the Storm: three cards, all
                // three of them sideboard-only, so every mainboard column is unchanged and exactly three
                // sideboard rows move. Read off the engine's own printed table, never hand-computed.
                listOf(
