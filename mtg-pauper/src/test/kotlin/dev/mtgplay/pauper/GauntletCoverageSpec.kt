        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Jeskai Ephemerate", 8, 22, 0, 7),
...
private const val TOTAL_ENCODED_MAIN = 60
private const val TOTAL_MISSING_MAIN = 118
...
private const val TOTAL_MISSING_BOTH_BOARDS = 149
