        ...
        "the gauntlet definition-coverage burn-down is pinned, mainboard and sideboard separately" {
            ...
            summary.decks.map { report ->
                ...
                listOf(
                    ...
                    Pinned("Mono Red Rally", 8, 13, 5, 5),
                    Pinned("Monster Tron", 14, 21, 4, 6),
                    Pinned("Spy Combo", 12, 21, 5, 8),
...
private const val TOTAL_ENCODED_MAIN = 133
private const val TOTAL_MISSING_MAIN = 45
